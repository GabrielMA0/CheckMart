<template>
        ...
        <section v-show="modalOpen" class="modal-add-product">
            <div class="background"></div>
                <div class="container-content" :class="{'open-modal-animation': modalOpen, 'close-modal-animation': animationCloseModal}">   

                    <AlertMessages v-show="showErrorMessage" :titleError="titleError" :errorMessage="errorMessage" :class="{'open-message-alert-warning': animationMessageError, 'close-message-alert-warning': !animationMessageError }"/>
                    ...
                    <form>
                        ...
                        <div class="container-fields">
                            ...
                            <input type="text" id="value-field" placeholder="Ex: R$ 5,00" v-model.lazy="valueInputPrice" v-money="money" @keydown="blockNegativeNumbers" :class="{'field-error': fieldErrorPrice}">
                        </div>

                        <div class="container-fields">
                            <label for="quantity-field">Qtda <span class="asterisk">*</span></label>
                            <input type="number" id="quantity-field" placeholder="Ex: 3" min="0" v-model="valueInputAmount" @keydown="blockNegativeNumbers" :class="{'field-error': fieldErrorAmount}">
                        </div>
    ...
    export default{
        ...
        methods:{
            ...
            fieldValidation(){
                ...
                if (!this.valueInputProduct || !this.valueInputPrice || !this.valueInputAmount || !this.valueInputCategory) {
