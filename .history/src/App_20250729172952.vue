<template>
  <div class="container">
    ...
    <ModalApp ref="setFieldsFromEditData" :modalOpen="modalOpen" :animationCloseModal="animationCloseModal" :modal="modal" :indexProduct="indexProduct" :modalTypeAdd="modalTypeAdd" :modalTypeEdit="modalTypeEdit" @closeModal="closeModal" @SaveProductEdit="SaveProductEdit"/>
