  ...
  methods: {
    ...
    organizeProducts() {
      ...
      if (this.selectValueOrganize === 'Menor preço') {
        return this.cartProducts.products.sort(function (x, y) {
      ...
      if (this.selectValueOrganize === 'Ordem Alfabética A-Z') {
        return this.cartProducts.products.sort((a, b) => {
  ...
  computed: {
    ...
    productsToDisplay() {
      ...
      if (this.searchFieldValue === '') {
        ...
        return this.searchedProducts = this.cartProducts.products.filter(product =>
