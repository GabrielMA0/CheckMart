        ...
        <div class="container-content"
            ...
            <form>
                ...
                <div class="container-fields">
                    ...
                    <input type="number" id="weight-field" placeholder="Ex: Morango" v-model="valueInputWeight">
                </div>
            </form>
...
export default {
    ...
    data() {
        ...
        // 1. Criar os dados do formulário
const form = reactive({
  name: '',
  email: ''
})

// 2. Criar as regras de validação para cada campo
const rules = {
  name: { required },       // nome é obrigatório
  email: { required } // email é obrigatório e precisa ter formato válido
}

// 3. Usar o Vuelidate para validar os dados com base nas regras
