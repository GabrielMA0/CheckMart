...
<template>
    ...
    <section v-show="modalStore.modal" class="modal-add-product">
        <div class="background" @click="modalStore.closeModal"></div>
        <div class="container-content"
            :class="{ 'open-modal-animation': modalStore.modal, 'close-modal-animation': !modalStore.modal }">
            ...
            <form @submit.prevent="addProduct">
                ...
                <div v-if="modal === modalTypeEdit" class="container-modal-edition">
                    ...
                    <Button class="btns cancel-button" type="button" @click="emit('closeModal')">Cancelar</Button>
