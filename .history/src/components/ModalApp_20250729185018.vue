...
console.log(valueInputProduct.value)
console.log(valueInputPrice.value)
console.log(valueInputAmount.value)
console.log(valueInputCategory.value)
console.log(valueInputBrand.value)
console.log(valueInputFlavor.value)
console.log(valueInputWeight.value)
return;
