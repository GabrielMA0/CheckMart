...
<template>
    ...
    <section v-show="modalStore.modal" class="modal-add-product">
        ...
        <div class="container-content"
            :class="{ 'open-modal-animation': modalStore.modal, 'close-modal-animation': props.animationCloseModal }">

            <button @click="emit('closeModal')" title="Fechar modal" class="close-button">
