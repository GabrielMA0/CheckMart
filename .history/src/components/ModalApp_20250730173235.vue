...
const schema = yup.object({
  ...
  price: yup.string().required('Preencha o campo obrigatório'),
...
const { value: product, errorMessage } = useField('product')
const { value: price } = useField('price')
const { value: amount } = useField('amount')
const { value: category } = useField('category')
const { value: brand } = useField('brand')
const { value: flavor } = useField('flavor')
        ...
        <div class="container-content"
            ...
            <form @submit.prevent="addProduct">
                <div class="container-fields">
                    ...
                    v-model="product"
                    :isRequired="true"
                    :hasError="submitCount > 0 && errorMessage ? true : false"
                    ...
                    :isRequired="true"
                    :hasError="submitCount > 0 ? true : false"
                    :messageError="errorMessage"
                    ></Input>
