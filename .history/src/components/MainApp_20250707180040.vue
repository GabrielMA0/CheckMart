  ...
  <main v-show="this.productData.length">
    <div class="container-cart">
      ...
      <div class="container-search-fields">
        ...
        <AlertMessages v-show="showWarningMessage"
          :class="{ 'open-message-alert-warning': animationMessageWarning, 'close-message-alert-warning': !animationMessageWarning }"
          :warningMessage="warningMessage" :titleWarning="titleWarning" />

        <AlertMessages v-show="showClearMessage"
          :class="{ 'open-message-alert-warning': animationMessageWarning, 'close-message-alert-warning': !animationMessageWarning }"
          :titleClear="titleClear" :clearMessage="clearMessage" />
      </div>
