...
export default {
    ...
    methods: {
        ...
        fillFieldsFromCart() {
            console.log(this.cartProducts.products)
            console.log(this.cartProducts.products.productName)
            this.valueInputProduct = this.cartProducts.products.productName;
            // this.valueInputPrice = this.cartProducts.products.price.toFixed(2);
            this.valueInputAmount = this.cartProducts.products.amount;
            this.valueInputCategory = this.cartProducts.products.category;
            this.valueInputBrand = this.cartProducts.products.brand;
            this.valueInputFlavor = this.cartProducts.products.flavor;
            this.valueInputWeight = this.cartProducts.products.weight;
        },
