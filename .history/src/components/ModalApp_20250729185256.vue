...
const schema = yup.object({
  ...
  amount: yup.string().required('Nome é obrigatório'),
  category: yup.string().required('Nome é obrigatório'),
  brand: yup.string().required('Nome é obrigatório'),
  product: yup.string().required('Nome é obrigatório'),
  flavor: yup.string().required('Nome é obrigatório'),
  weight: yup.string().required('Nome é obrigatório'),
})
