<template>
  <div class="container">
    ...
    <ModalApp :modalOpen="modalOpen" :animationCloseModal="animationCloseModal" :modal="modal" :indexProduct="indexProduct" :modalTypeAdd="modalTypeAdd" :modalTypeEdit="modalTypeEdit" @closeModal="closeModal"/>
