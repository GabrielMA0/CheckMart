<template>
  <div class="container">
    ...
    <MainApp :productData="productData" @removeProduct="removeProduct" @editProduct="editProduct" @cleanShoppingCart="cleanShoppingCart"/>
  </div>
</template>
  ...
  export default{
    ...
    methods: {
      ...
      removeProduct(index){
        ...
        this.cartProducts.removeProduct(index)
