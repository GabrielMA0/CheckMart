...
<template>
    <Container>
        ...
        <form v-show="!teste" @submit.prevent="addProduct">
        ...
        <section v-show="teste" class="container-section-result">
          <div class="container-result">
            ...
            <div class="container-result-product">
              <h3>Papel Higiênico Personal 12R</h3>
              <span><strong></strong>Valor: R$ 19,99</span>
              <span><strong></strong>Valor por unidade: R$ 1,66</span>
              <span><strong></strong>Valor por LT/ML: R$ 1,66</span>
              <span><strong></strong>Valor por KG/G: R$ 1,66</span>
              <Button>Adicionar no carrinho</Button>
            </div>
          </div>
          ...
          <div class="container-best-option">
            ...
            <span>Produto: Papel Higiênico Folha Dupla Deluxe Cotton 12 Rolos</span>
            <span>Valor: -R$ 3,36</span>
            <span>Valor por unidade: R$ 1,36</span>
            <span>Valor por LT/ML: R$ 1,36</span>
            <span>Valor por KG/G: R$ 1,36</span>
