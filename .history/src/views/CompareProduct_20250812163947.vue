...
const currencyOptions = {
  ...
  currency: 'BRL',
  distractionFree: {
    hideCurrencySymbol: true,     // Esconde o "R$" até começar a digitar
    hideGroupingSeparator: false, // Mantém os separadores de milhar
  },
  autoDecimalMode: true,           // Permite digitar só números e já trata vírgula automaticamente
}
