...
watch(() => unityCheckbox.value, (value) => {
    console.log(value);
})
...
const clearFields = () => {
//   unityCheckbox.value = false;
// volumeCheckbox.value = false;
// weightCheckbox.value = false;
  resetForm()
    ...
    <Container>
        ...
        <form @submit.prevent="addProduct">
            ...
            <div class="container-btns">
                ...
                <Button @click="clearFields">Limpar campos</Button>
                <router-link to="/">
