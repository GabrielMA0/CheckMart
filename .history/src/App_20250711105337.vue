<template>
  <div class="container">
    ...
    <ModalApp ref="setFieldsFromEditData" :modalOpen="modalOpen" :animationCloseModal="animationCloseModal" :modal="modal" :indexProduct="indexProduct" :modalTypeAdd="modalTypeAdd" :modalTypeEdit="modalTypeEdit" :animationMessageError="animationMessageError" @closeModal="closeModal" @SaveProductEdit="SaveProductEdit"/>
    <MainApp @editProduct="editProduct"/>
  </div>
</template>
  ...
  export default{
    ...
    methods: {
      ...
      SaveProductEdit(editedProduct){
        ...
        this.cartProducts.editProduct(editedProduct, this.indexProduct)
        this.modal = this.modalTypeEdit
        this.closeModal()

        this.cartProducts.calculateTotal()
